...
<script>
  export default {
    ...
    methods: {
      fetchResource () {
        this.$http.get('https://node-mu-nine.vercel.app/api/programmersresource/' + this.$route.params.id).then(response => {
      ...
      onSaveChange: function () {
        ...
        this.$http.put('https://node-mu-nine.vercel.app/api/programmersresource/' + this.$route.params.id, updateResource).then(response => {
